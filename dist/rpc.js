...
var a = (t, e) => Xe(t, "name", { value: e, configurable: !0 });
const he = [/* @__PURE__ */ new Map(), /* @__PURE__ */ new Map()];
function B(t) {
  return function(e) {
    const [n, r] = he;
    n.set(t, e), r.set(e, t);
...
a(Qe, "getDefaultExportFromCjs");
var Te = { exports: {} }, fe = { exports: {} }, Oe;
function Ye() {
  return Oe || (Oe = 1, function(t, e) {
    (function(n, r) {
      ...
      a(i, "_getter");
      var s = ["isConstructor", "isEval", "isNative", "isToplevel"], c = ["columnNumber", "lineNumber"], l = ["fileName", "functionName", "source"], o = ["args"], b = ["evalOrigin"], u = s.concat(c, l, o, b);
      function h(f) {
        if (f)
      ...
      a(h, "StackFrame"), h.prototype = {
        ...
        toString: function() {
          var f = this.getFileName() || "", d = this.getLineNumber() || "", _ = this.getColumnNumber() || "", H = this.getFunctionName() || "";
          return this.getIsEval() ? f ? "[eval] (" + f + ":" + d + ":" + _ + ")" : "[eval]:" + d + ":" + _ : H ? H + " (" + f + ":" + d + ":" + _ + ")" : f + ":" + d + ":" + _;
        }
      }, h.fromString = /* @__PURE__ */ a(function(d) {
        var _ = d.indexOf("("), H = d.lastIndexOf(")"), Ve = d.substring(0, _), qe = d.substring(_ + 1, H).split(","), Ce = d.substring(H + 1);
        if (Ce.indexOf("@") === 0)
          var ue = /@(.+?)(?::(\d+))?(?::(\d+))?$/.exec(Ce, ""), ze = ue[1], Je = ue[2], He = ue[3];
        return new h({
          functionName: Ve,
          args: qe || void 0,
          fileName: ze,
...
a(Ye, "requireStackframe");
(function(t, e) {
  (function(n, r) {
    t.exports = r(Ye());
  })($e, /* @__PURE__ */ a(function(r) {
    ...
    return {
      ...
      extractLocation: /* @__PURE__ */ a(function(o) {
        if (o.indexOf(":") === -1)
          return [o];
        var b = /(.+?)(?::(\d+))?(?::(\d+))?$/, u = b.exec(o.replace(/[()]/g, ""));
...
`).length ? this.parseOpera9(o) : o.stack ? this.parseOpera11(o) : this.parseOpera10(o);
      ...
      parseOpera9: /* @__PURE__ */ a(function(o) {
        for (var b = /Line (\d+).*script (?:in )?(\S+)/i, u = o.message.split(`
`), h = [], g = 2, w = u.length; g < w; g += 2) {
      ...
      parseOpera10: /* @__PURE__ */ a(function(o) {
        for (var b = /Line (\d+).*script (?:in )?(\S+)(?:: In function (\S+))?$/i, u = o.stacktrace.split(`
...
caused by: ` + ge(t.toString()) + ne(te.parse(t)) + Pe(t.cause) : `
caused by: ` + ge(t?.toString() ?? "null");
}
a(Pe, "causeToString");
function Ae(t, e) {
  return (t === m || Ae(t.__proto__, e)) && e[0].functionName?.replace(/^new /, "") === t.name ? (e.shift(), !0) : !1;
}
a(Ae, "removeFromStackTrace");
class m extends Error {
  ...
  constructor(...e) {
    ...
    const l = he[1].get(this.constructor);
    if (l != null && (this.data.$type = l), Object.assign(this.data, s ?? {}), i == null)
      this.#n = !0, this.#t = te.parse(this), Ae(this.constructor, this.#t);
    else {
      this.#e = `
` + ge(i);
...
caused by: `);
    ...
    this.#r += Pe(c), this.stack = this.toString();
  }
  toString() {
...
const Me = globalThis?.process?.versions?.node != null, Ne = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", we = /* @__PURE__ */ a(() => Date.now().toString(36) + Array(10).fill(void 0).map(() => Ne[Math.floor(Math.random() * Ne.length)]).join(""), "randomId");
let R;
if (Me)
  try {
    process?.versions.bun ? R = "bun@" + require("os").hostname() + "@" + process.pid : R = "node@" + process.binding("os").getHostname() + "@" + process.pid;
  } catch {
    R = "node-alternative@" + process.platform + ":" + process.arch + "@" + process.pid;
  }
else
  "document" in globalThis ? R = "web@" + document.location + "#" + we() : R = "js@" + we();
var ke = Object.defineProperty, et = Object.getOwnPropertyDescriptor, tt = /* @__PURE__ */ a((t, e, n) => e in t ? ke(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, "__defNormalProp"), J = /* @__PURE__ */ a((t, e, n, r) => {
  for (var i = r > 1 ? void 0 : r ? et(e, n) : e, s = t.length - 1, c; s >= 0; s--)
    (c = t[s]) && (i = (r ? c(e, n, i) : c(i)) || i);
  return r && i && ke(e, n, i), i;
}, "__decorateClass"), Z = /* @__PURE__ */ a((t, e, n) => (tt(t, typeof e != "symbol" ? e + "" : e, n), n), "__publicField");
...
a(nt, "getFunctionParameterNames");
function x(t) {
  if (t[0] == "/") {
    if (t[1] == "/") {
      const e = t.indexOf(`
...
a(x, "identifier");
const rt = "1.5.1", Re = /* @__PURE__ */ Object.create(null), S = /* @__PURE__ */ new Map();
S.set("$" + R, Re);
function it() {
  return "$" + R + "$" + we();
}
a(it, "generateTypeName");
async function Fe(t, e) {
  if (!S.has(t)) {
    ...
    try {
      ...
      console.error(`[Rpc] Error registering type "${t}":`, n), S.delete(t);
    }
  }
}
a(Fe, "registerType");
...
async function Ie(t, e, n, ...r) {
  if (n != null) {
    let s = t[n];
    if (s == null) {
      let l = (await xe(t)).find((o) => o.toLowerCase() == n.toLowerCase());
      l != null && (s = t[l]);
    }
    const c = {}[n];
    if (s == null || s === c)
  ...
  switch (i) {
    case "M":
      return xe(t);
    case "S":
      return at(t, e, r[1] == null ? null : "" + r[1], !!r[2]);
    case "V":
      return ot(t);
    default:
      throw z.new(e, i);
...
async function at(t, e, n, r) {
  ...
  return s[re] ? s[re].call(s, r) : [
    [nt(s), r ? "unknown" : "object?"]
  ];
}
a(at, "getMethodSignatures");
async function xe(t) {
  const e = t[Y];
  ...
  constructor(e, n) {
    try {
      ...
      this.promise = new Promise((i, s) => {
        K.set(this, (c) => {
          K.delete(this), E.delete(this), this.finished = !0, i(c), ae(n);
        }), E.set(this, (c) => {
          K.delete(this), E.delete(this), this.finished = !0, s(c instanceof m ? c.unfreeze(r, e) : c), ae(n);
        });
      });
    }
  }
...
a(lt, "getFunctionContext");
let ut = 0;
function y(t, e, ...n) {
  if (t != null) {
    const l = S.get(t);
    if (l)
      return Be(Ie.bind(null, l, t, e, ...n), t, e, n, 3);
  }
  const r = [], i = new ve(2, r), s = new k(), c = ut++;
  try {
    s.writeByte(v.FunctionCall), s.writeLength(c), s.writeString(t), s.writeString(e), s.writeArray(n, (l) => s.writeDynamic(l, r));
  } catch (l) {
    return E.get(i)?.(l), i;
  }
  return I || t == null && q != null ? (i.sendMessage = (...l) => {
    if (i.finished)
      return i;
    const o = new k();
    o.writeByte(v.MessageToExecutor), o.writeLength(c);
    const b = [];
    return o.writeArray(l, (u) => o.writeDynamic(u, b)), r.push(...b), V(o), i;
  }, i.cancel = () => {
    if (i.finished)
      return;
    const l = new k();
    l.writeByte(v.FunctionCancel), l.writeLength(c), V(l);
  }, i.getCaller = () => y(null, "c", c), wt(c, i, s), i) : (E.get(i)?.(P.new("Not connected")), i);
}
a(y, "callRemoteFunction");
function ft(t) {
  return Be(t, null, null, null, 3);
}
a(ft, "callLocal");
function Be(t, e, n, r, i) {
  const s = new ve(i, []), c = new AbortController(), l = {
    ...
    promise: s,
    addMessageListener: (o) => le(l, o),
    cancelToken: c.signal,
    cancelSelf: () => c.abort(),
    [Symbol.asyncIterator]: () => ce(l)
  };
  return s.sendMessage = (...o) => (s.finished || Q(l, o), s), s.cancel = () => s.finished || l.cancelSelf(), je(t, l, K.get(s), E.get(s), e, n, r), s;
}
a(Be, "callLocalFunction");
async function je(t, e, n, r, i, s, c) {
  try {
    let l;
    const o = $;
    $ = e;
...
const O = class extends (/* @__PURE__ */ a(function(n) {
  ...
  async getMethodSignatures(e = !1) {
    return y(this.type, null, "S", this.method, e);
  }
  toString() {
...
function Ee(t) {
  ...
  if (e != null)
    return new O("$" + R, e);
  const n = (ht++).toString(16);
  Re[n] = t, pe.set(t, n);
  const r = "$" + R;
  return new O(r, n);
}
a(Ee, "registerFunction");
function Se(t) {
  const e = "$" + R;
  if (t.type != e)
    throw new Error("Can't unregister RemoteFunction, that was not registered locally");
  delete Re[t.method], pe.delete(t);
}
a(Se, "unregisterFunction");
const M = Symbol("RpcObjectType"), ie = Symbol("RpcObjectExists"), Y = Symbol("RpcObjectGetMethods"), re = Symbol("RpcObjectGetMethodSignatures"), se = Symbol("RpcObjectGetRpcVersion");
function G(t, e = new class {
  ...
  return new Proxy(e, {
    ...
    has(r, i) {
      return i == M || i == Y || i == ie || i == se || i in e;
    }
  });
}
...
function ye(t, e) {
  ...
  if (n < 0) {
    ...
    const r = new TextDecoder().decode(t.readBuffer(n - 128)), i = Ke.get(r);
    if (i)
      return i(t, e);
...
function be(t, e, n) {
  ...
  else if (typeof e == "object" && M in e)
    t.writeLength(79), t.writeString(e[M]);
  else if (typeof e == "function") {
    n.push(e), t.writeLength(70);
    let r;
    e instanceof O ? r = e : (r = Ee(e), We.set(e, () => Se(r))), t.writeString(r.type), t.writeString(r.method);
...
a(wt, "sendCall");
var v = /* @__PURE__ */ ((t) => (t[t.FunctionCall = 0] = "FunctionCall", t[t.FunctionSuccess = 1] = "FunctionSuccess", t[t.FunctionError = 2] = "FunctionError", t[t.FunctionCancel = 3] = "FunctionCancel", t[t.MessageToExecutor = 4] = "MessageToExecutor", t[t.MessageToCaller = 5] = "MessageToCaller", t))(v || {});
async function dt(t) {
  const e = t.readByte();
  switch (e) {
    case 0: {
      ...
      const l = new Promise((o, b) => {
        s = /* @__PURE__ */ a((u) => {
          ...
          h.writeByte(
            1
            /* FunctionSuccess */
          ), h.writeLength(n), h.writeDynamic(u), V(h), j.delete(n), ae(r);
          ...
          h.writeByte(
            2
            /* FunctionError */
          ), h.writeLength(n), h.writeError(u), V(h), j.delete(n), ae(r);
        }, "reject");
      });
      l.catch(() => {
      });
      try {
        ...
        const u = t.readString(), h = t.readArray(() => t.readDynamic(r)) ?? [], g = new AbortController(), w = {
          ...
          sendMessage(...p) {
            ...
            const d = [];
            return f.writeArray(p, (_) => f.writeDynamic(_, d)), r.push(...d), V(f), w;
          },
          ...
          cancelSelf: () => g.abort(),
          [Symbol.asyncIterator]: () => ce(w)
        };
        j.set(n, w), await je(Ie.bind(null, b, o, u, ...h), w, s, c, o, u, h);
      } catch (o) {
        o instanceof m || (o = L.new(`Error reading binary stream (${v[e]})`, o)), c(o);
      }
      break;
    }
    case 1: {
      ...
      if (r == null) {
        console.warn(`[Rpc] No activeRequest[${n}] (${v[e]})`);
        break;
      }
      try {
        K.get(r)?.(t.readDynamic());
      } catch (i) {
        E.get(r)?.(L.new(`Error reading binary stream (${v[e]})`, i));
      } finally {
        N.delete(n);
      }
      break;
    ...
    case 2: {
      ...
      try {
        ...
        try {
          ...
          i = L.new(`Error reading binary stream (${v[e]})`, s);
        }
        throw i;
      } catch (i) {
        E.get(r)?.(i);
    ...
    case 3: {
      ...
      let r = j.get(n);
      if (!r) {
        console.warn(`[Rpc] No currentlyExecuting[${n}] (${v[e]})`);
        break;
      }
      r.cancelSelf();
      break;
...
let I = !1, _e, me, oe = new Promise((t, e) => [_e, me] = [t, e]);
oe.catch(() => {
});
async function pt() {
  for (; ; )
    if (await oe.then(() => !0, () => !1))
      return;
}
a(pt, "waitConnected");
let D;
...
function Le(t) {
  const e = me;
  oe = new Promise((n, r) => [_e, me] = [n, r]), oe.catch(() => {
  }), e(t), gt(t);
}
a(Le, "closeRpc");
let q = null;
async function yt(t) {
  let e = A, n = /* @__PURE__ */ new Set();
  const r = new URLSearchParams();
  r.set("id", R), n.add("$" + R), e != null && r.set("name", e);
  for (let s of S.keys())
    n.has(s) || (n.add(s), r.append("type", s));
  const i = await D(r);
  i.onclose = () => {
    setTimeout(t, 1e3), q && (q = null, I = !1, console.info("[Rpc] Reconnecting to RPC"), Le(P.new("Connection closed by " + C.prettyName)));
  }, i.onopen = async () => {
    console.info("[Rpc] Connected to RPC");
    try {
      q = i;
      const s = new Set(S.keys()), c = new Set(n);
      for (let l of s)
        c.delete(l) && s.delete(l);
      s.size || c.size ? A != e ? await y(null, "H", A, [...s.keys()], [...c.keys()]) : await y(null, "H", [...s.keys()], [...c.keys()]) : A != e && await y(null, "H", A), I = !0, _e();
    } catch (s) {
      console.error("[Rpc] Error connecting to RPC: ", s), Le(s), i?.close(4e3, "Error registering types");
      return;
    }
  }, i.binaryType = "arraybuffer", i.onmessage = (s) => {
    const c = s.data;
    typeof c == "string" ? console.log("[Rpc] WebSocket Message:", c) : dt(new Ge(new Uint8Array(c))).catch((l) => console.warn("[Rpc] Error receiving Packet:", l));
  };
}
a(yt, "connectOnce");
...
function mt(t) {
  return function(e) {
    Ue.push([t, (n) => n instanceof e, (n, r, i) => r.write(n, i)]), Ke.set(t, (n, r) => e.read(n, r));
  };
}
a(mt, "CustomDynamicType");
function Rt(t) {
  return (e) => void Fe(t ?? e.prototype.constructor.name, e);
}
a(Rt, "RpcProvider");
Promise.resolve().then(() => vt).then((t) => Object.assign(globalThis, t));
class C {
  //Rpc
  static id = R;
  ...
  static getContext = lt;
  static runWithContext = ct;
  //Types
  static registerType = Fe;
  static unregisterType = st;
  static generateTypeName = it;
...
export {
  ...
  se as RpcObjectGetRpcVersion,
  M as RpcObjectType,
  Rt as RpcProvider,
  F as RpcTypeNotFoundError,
  G as createRemoteObject,
  ce as getAsyncIterator,
  W as listenersMap,
  U as pendingMap,
  Ee as registerFunction,
  le as registerReceive,
  E as rejectCall,
  K as resolveCall,
